...
public class User {
    ...
    public Integer getFansCounts() { return fansCounts; }

    public void setFansCounts(Integer fansCounts) { this.fansCounts = fansCounts; }

    public Integer getFollowCounts() { return followCounts; }

    public void setFollowCounts(Integer followCounts) { this.followCounts = followCounts; }

    public Integer getReceiveLikes() { return receiveLikes; }

    public void setReceiveLikes(Integer receiveLikes) { this.receiveLikes = receiveLikes; }
